...
inscriptions.adding_labels_and_buttons_to_root(
    app_contex.root,
    settings.player1_ship_count_coordinated,
    settings.player2_ship_count_coordinated,
    settings.message_label_object_coordinated,
    settings.direction_btn_object_coordinated
)
